...
class M_PanduanPakan extends DB_HANDLER {
    ...
    protected $database = [
        ...
        "data2" => "`id_jenis_ikan`, `batas_umur`, `umur`, `berat_ikan`, `panjang`, `jenis_pakan`, `ukuran_pakan`, `frekuensi`, `dosis_pakan`",
    ...
    public function getDataPanduan($umur,$ikan){
        ...
        $where = "panduan_pakan.`id_jenis_ikan` = ".$ikan." AND `batas_umur` BETWEEN ".$umur." AND ".'900';
